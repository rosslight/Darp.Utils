...
{{classIndent}}}
""";
        var debugInformation = resourceCollection.GenerateDebugInformation(classIndent);
        var result = $"""
// <auto-generated/>
{debugInformation}
#nullable enable
...
""";
    ...
    private static string? GenerateDebugInformation(this ResourceCollection resourceCollection, string classIndent)
    {
